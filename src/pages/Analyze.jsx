...
//           content={
//             <>
//               <p><b>Word Count:</b> {analysis.wordCount}</p>
//               <p><b>Sentence Count:</b> {analysis.sentenceCount}</p>
//               <p><b>Headings Detected:</b> {analysis.hasHeadings ? "Yes" : "No"}</p>
//               <p><b>Long Sentences:</b> {analysis.longSentences}</p>
//               <p><b>Top Keywords:</b> {analysis.topKeywords.join(", ") || "None"}</p>
